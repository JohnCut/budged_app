        ...
        child: Column(children: [
          Container(
            child: Column(
                  children: [
                    Text(
                      'Zorunlu Harcamalar (İH)'
                    ),
                    Row(
                      children: [
                        Text('%',),
                        Flexible(child: TextField(controller: ihTC,
                    ...
                    Text(
                      'İsteğe Bağlı Harcamalar (İS)'
                    ),
                    Row(
                      children: [
                        Text('%',),
                        Flexible(child: TextField(controller: isTC,
                        keyboardType: TextInputType.number,
                        maxLength: 2,))
                      ]
                    ),
                    ...
                    Row(
                      children: [
                        Text('%',),
                        Flexible(child: TextField(controller: tasTC,
                        keyboardType: TextInputType.number,
                        maxLength: 2,))
                      ]
                    ),
                    RaisedButton(child: Text('Plan Oluştur'),
                    onPressed: () {
                      verifyPerc();
